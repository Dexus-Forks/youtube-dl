...
def run_update(ydl):
    ...
    JSON_URL = 'https://api.github.com/repos/Dexus-Forks/youtube-dl/releases/latest'
    ...
    def report_network_error(action, delim=';'):
        report_unable('%s%s Visit  https://github.com/Dexus-Forks/youtube-dl/releases/latest' % (action, delim), True)
